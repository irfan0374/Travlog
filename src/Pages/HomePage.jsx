...
import Carousel from '../Componets/Carousal'
  ...
  return (
    ...
    <div className='w-[55vh] h-[45vh] mx-2 m-4 md:w-[60vh] md:h-[30vh] lg:w-80 md:m-6 lg:m-8 md:mx-20'>
      <div className='shadow-md rounded-2xl w-48 flex justify-center py-1 text-pink-500 mx-auto'>
        ...
        <img className='w-5 h-4 m-1' src={bag} alt="Bag Icon" />
      </div>
      ...
      <p className='text-center mb-6 text-balance text-sm md:text-lg md:text-center lg:my-16'>
        We always make our customer happy by providing as many choices as possible
      </p>
      <div className='flex flex-col md:flex-row lg:flex-row justify-evenly mt-3 items-center md:justify-center mx-2 md:mx-0 lg:ml-12'>
